    ...
    render() {
        ...
        return (
            ...
            >
                {/* <Modal.Header> */}
                    {/* <Modal.Title> */}
                    <div style={{padding: '24px 24px 20px 24px', backgroundColor: '#F8F8F8', fontWeight: 'bold', borderRadius: '16px'}}>
                        {this.getModalTitle()}
                    </div>
                    {/* </Modal.Title> */}
                {/* </Modal.Header> */}
                    ...
                    <form>
                        <FormGroup>
                            <FormLabel>
                                ...
                                >{txt => <div style={{ color: '#4B4B4B' }}>{txt}</div>}</FormattedMessage>
                            </FormLabel>
                            <FormControl
                                id='teamNameInput'
                                type='text'
                            ...
                            <FormText>
                                ...
                                >{txt => <div style={{ color: '#6F6F6F' }}>{txt}</div>}</FormattedMessage>
                            </FormText>
                        </FormGroup>
                        <FormGroup
                ...
                <div style={{ display: 'flex', justifyContent: 'right', padding: '0 26px 26px 26px' }}>
                    {this.props.onClose &&
                        <Button
                            style={{ padding: '8px 38px', marginRight: '18px' }}
