...
* `Invochat.exe --args --data-dir C:\my-invochat-data` on Windows
* `open /Applications/Invochat.app/ --args --data-dir ~/my-invochat-data/` on macOS 
* `./invochat-desktop --args --data-dir ~/my-invochat-data/` on Linux
